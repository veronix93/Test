...
class VICTORYBPLIBRARY_API UVictoryBPFunctionLibrary : public UBlueprintFunctionLibrary
{
	...
	UFUNCTION(BlueprintPure, Category = "VictoryBPLibrary|String", meta=( CommutativeAssociativeBinaryOperator = "true"))
...
UFUNCTION(BlueprintPure, meta = (FriendlyName = "Append Multiple", Keywords = "concatenate combine append strings", CommutativeAssociativeBinaryOperator = "true"), Category = "VictoryBPLibrary|String")
